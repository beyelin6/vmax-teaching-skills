...
- 課文／生字／詞語／成語／語文活動
- AI 分析與教師決策分層
- Lesson / Session / Teaching Intent

### B. Renderer Script MD
逐頁／逐 Shot 施工圖，負責：
...
預設：
- 完整內容放 Source Master MD。
- 逐頁生成要求放 Renderer Script MD。
- 視覺一致性放 Visual YAML MD。
- 操作指令只描述「如何使用這三份來源」。
...
1. 依 Renderer Script 的頁序與 learning_gain 生成。
