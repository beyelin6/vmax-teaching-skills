...
text_layer_construction_policy: { path: core/presentation/text-layer-construction-policy.md, current_version: 1.3 }
...
presentation_engine: { path: skills/presentation-engine/SKILL.md, current_version: 0.10.9 }
...
Execution Rules 1.5 / Presentation Engine 0.10.9 / Renderer Contract 2.0 / Image Renderer 2.1 / Quality Gate 3.1 / Text Layer 1.3 / Classroom Language 1.5 / Render Request 2.2 / Slide Script object-composition-glyph-anchor-idiom-v3 / Front Door 1.3。
