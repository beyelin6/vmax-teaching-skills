...
Idiom pages follow the Runtime idiom-page rule in `core/director/idiom-expression-visualization-policy.md`: keep the idiom, necessary meaning, approved source/example sentence, and comprehension-serving illustration; do not add reflection, practice, answer blanks, or a worksheet-style bottom block.
